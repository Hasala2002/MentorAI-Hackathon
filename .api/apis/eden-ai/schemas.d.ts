    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly examples: readonly ["sapling,winstonai,originalityai"];
            };
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["amazon,emvista,openai,microsoft"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["replicate,perplexityai,anthropic,openai,meta,cohere,google,mistral"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["openai,google,nlpcloud"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["cohere,mistral,jina,openai,google"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["nlpcloud,vernai"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["mistral,anthropic,cohere,ai21labs,openai,meta,amazon,google"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["amazon,ibm,corticalio,emvista,openai,microsoft,nlpcloud,tenstorrent"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["google,openai,clarifai,microsoft"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["microsoft,amazon,google,neuralspace,lettria,tenstorrent,ibm,openai,nlpcloud"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["winstonai,originalityai"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["tenstorrent,openai"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["openai,google,cohere"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["sapling,google,microsoft,emvista,tenstorrent,connexun,ibm,lettria,openai,amazon,nlpcloud"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["ai21labs,nlpcloud,openai,microsoft,cohere,sapling,prowritingaid"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["microsoft,emvista,openai,ai21labs,anthropic,alephalpha,nlpcloud,connexun,cohere"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["amazon,emvista,lettria,ibm,google"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
    ...
    readonly body: {
        ...
        readonly properties: {
            readonly providers: {
                ...
                readonly minLength: 1;
                readonly description: "It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.<br>             Providers can also be invoked with specific models (ex: providers: **'amazon/model1, amazon/model2, google/model3'**)";
                readonly examples: readonly ["tenstorrent,google,ibm,openai"];
            };
            readonly fallback_providers: {
                readonly type: readonly ["string", "null"];
                readonly description: "Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.\n    To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.\n\nThey will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.\n\n\n*Doesn't work with async subfeatures.*\n    ";
